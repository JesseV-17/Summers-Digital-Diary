...
- The Thing I'm Ashamed Of
- Late Night Anxiety
- The Dream I Haven't Told Anyone

## 🎨 Design

- **Modern split-pane layout** with sidebar navigation
- **Gradient purple theme** with smooth animations
- **Fully responsive** - works on desktop, tablet, and mobile
- **Active entry highlighting** for easy navigation
...
- Vanilla JavaScript
- LocalStorage API (for passcode)

---

Made with 💜 for keeping your thoughts and memories safe!
